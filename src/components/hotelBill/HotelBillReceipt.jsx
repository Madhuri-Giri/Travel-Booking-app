  ...
  const bookingCancel = async (event) => {
    ...
    try {
        ...
        if (res.data) {
            ...
            console.error('API Message:', res.message);
            setError(res.message);
            toast.error(res.message);
        } else if (res.api_response && res.api_response.Error) {
            
            const errorCode = res.api_response.Error.ErrorCode;
            const errorMessage = res.api_response.Error.ErrorMessage || 'No detailed error message provided';

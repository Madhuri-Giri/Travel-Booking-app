...
//             <input type="text" placeholder="Contact" value={editedAge} onChange={(e) => setEditedAge(e.target.value)} />
...
//             <input type="text" name="Contact" placeholder="Contact" value={newPassengerData.Phoneno} onChange={handleNewPassengerInputChange} required />
